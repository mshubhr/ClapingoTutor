...
public final class RvLayoutBinding implements ViewBinding {
  ...
  private RvLayoutBinding(@NonNull LinearLayout rootView, @NonNull TextView ts1,
  ...
  @NonNull
  public static RvLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RvLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.rv_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RvLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RvLayoutBinding((LinearLayout) rootView, ts1, ts2, ts3);
    }
